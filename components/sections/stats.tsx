...
function CountUp({
  ...
  useEffect(() => {
    if (isInView) {
      ...
      motionValue.set(0); // reset when leaving viewport
    }
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-2">
          ...
          {/* Left content */}
          <SlideInLeft>
            <p className="text-sm font-semibold text-primary">Our impact</p>

            <h2 className="mt-3 text-3xl font-bold tracking-tight text-primary-foreground sm:text-4xl lg:text-5xl">
              Trusted across Southeast Asia.
            </h2>

            <p className="mt-5 text-base leading-relaxed text-primary-foreground/60">
