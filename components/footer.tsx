...
export function Footer() {
  ...
  // All navigation and product links are dynamically localized here
  const links = {
    company: [
  ...
  return (
    <footer className="relative bg-[#0a1628] text-slate-300 border-t border-slate-800 overflow-hidden font-sans">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 py-16 lg:px-8 lg:py-24">
        ...
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 md:grid-cols-[200px_1fr_1fr_1fr] lg:grid-cols-[260px_1fr_1fr_1fr] xl:grid-cols-[300px_1fr_1fr_1fr] items-start">
          ...
          <div className="flex flex-col">
            <Link href="/" className="inline-block transition-transform hover:scale-[1.02]">
              <Image 
                ...
                width={400}
                height={240}
                className="h-[110px] w-auto object-contain brightness-[1.1] sm:h-[60px] md:h-[80px] lg:h-[120px] xl:h-[140px]"
                alt="Farmacosm Logo"
              />
            </Link>
          </div>
        ...
        <div className="mt-16 border-t border-slate-800/60 pt-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <p className="text-[11px] tracking-[0.35em] text-slate-500 uppercase">
            &copy; {new Date().getFullYear()} Farmacosm. {t("footer.copyright")}
          </p>
